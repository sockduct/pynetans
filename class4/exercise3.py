#!/usr/bin/env python
####################################################################################################
'''Use pexpect to retrieve show ip int brief output from pynet-rtr2.'''
...
def main(args):
    ...
    parser = argparse.ArgumentParser(
        description='Retrieve show ip int brief output from specified router')
    ...
    if args.verbose:
        print output
    output = myrouter_conn.send_cmd('show ip interface brief')
    print output
